const { getAllProducts, createProduct, updateProduct, deleteProduct, getProductDetails, createProductReview, productReviews } = require('../controllers/productController')
